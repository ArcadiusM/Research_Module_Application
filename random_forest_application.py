...
for train_index, test_index in kf.split(X):
    ...
    accuracyResults.append(forest.score(X_test, Y_test))
...
# Log accuracy result
with open("logs/random_forest_results.log", "w") as logFile:
...
plt.title("Confusion matrix for Random Forest averaged over 5 folds")
